...
def enc_image(input_data,key,iv,filepath):
	...
	enc_file = open(filepath+"encrypted_image.enc", "wb")
...
def dec_image(input_data,key,iv,filepath):
	...
	output_file = open(filepath+"decrypted_image.png", "wb")
...
def decryptimg(aes_key):
    
        enc_pass = aes_key

        filename ="client_encrypted_image.enc"
