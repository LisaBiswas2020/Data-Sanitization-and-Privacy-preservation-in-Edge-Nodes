...
def enc_image(input_data,key,iv,filepath):
    ...
    enc_file = open(filepath+"encrypted_pdf.enc", "wb")
...
def dec_image(input_data,key,iv,filepath):
    ...
    output_file = open(filepath+"decrypted_pdf.pdf", "wb")
...
def decryptpdf(aes_key):
    
        enc_pass = aes_key

        filename ="client_encrypted_pdf.enc"
